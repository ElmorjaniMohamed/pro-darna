    ...
    <nav x-data="sidebar"
        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            <div class="flex justify-between items-center px-4 py-3">
                <a href="{{route('home')}}" class="main-logo flex items-center shrink-0">
                    <img class="w-8 ltr:-ml-1 rtl:-mr-1 inline dark:hidden" src="/assets/images/logo/logo.svg" alt="image" />
                    <img class="w-8 ltr:-ml-1 rtl:-mr-1 hidden dark:inline" src="/assets/images/logo/logo-white.svg" alt="image" />
                    <span class="text-2xl ltr:ml-1.5 rtl:mr-1.5 font-semibold align-middle hidden md:inline dark:text-white-light transition-all duration-300">PRODARNA</span>
                </a>
                <a href="javascript:;"
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="nav-item">
                    <ul class="space-y-2">
                        ...
                        <li
                            class="nav-item rounded-md  {{ request()->routeIs('messages.*') ? 'bg-[#000]/[0.08] text-black dark:bg-[#181f32] dark:text-white-dark' : '' }}">
                            <a href="{{ route('messages.index') }}" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Messages</span>
                                </div>
                            </a>
                        </li>
                    </ul>
                ...
                <li class="nav-item">
                    <ul class="space-y-2">
                        ...
                        @if (auth()->user()->hasRole('admin'))
                            <li
                                ...
                                <a href="{{ route('propertyAmenities.index') }}" class="group">
                                    <div class="flex items-center">
                                        <svg class="group-hover:!text-primary {{ request()->routeIs('propertyAmenities.*') ? '!text-primary' : '' }} shrink-0"
                                            width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                        ...
                        @endif
                        <li
                            class="nav-item rounded-md {{ request()->routeIs('properties.*') ? 'bg-[#000]/[0.08] text-black dark:bg-[#181f32] dark:text-white-dark' : '' }}">
                            <a href="{{ route('properties.index') }}" class="group">
                                <div class="flex items-center">

                                    <svg class="group-hover:!text-primary {{ request()->routeIs('properties.*') ? '!text-primary' : '' }} shrink-0"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
