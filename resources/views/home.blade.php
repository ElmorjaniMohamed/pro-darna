                        ...
                        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                            ...
                            <div class="swiper-slide">
                                <div
                                    ...
                                    <div class="relative">
                                        <a href="properties-details.html" class="block">
                                            <img src="assets/images/properties/properties1.png" class="w-full h-full"
                                        ...
                                        <div class="flex flex-wrap flex-col absolute top-5 right-5">
                                            <button
                                                class="flex flex-wrap items-center bg-[rgb(11,44,61,0.8)] p-[5px] rounded-[2px] text-white mb-[5px] text-xs"><img
                                                    class="mr-1" src="assets/images/icon/camera.png" loading="lazy"
                                                    width="13" height="10" alt="camera icon">07</button>
                                            <button
                                                class="flex flex-wrap items-center bg-[rgb(11,44,61,0.8)] p-[5px] rounded-[2px] text-white text-xs"><img
                                                    class="mr-1" src="assets/images/icon/video.png" loading="lazy"
                                                    width="14" height="10" alt="camera icon">08</button>
                                        </div>
                                        <span
                                            class="absolute bottom-5 left-5 bg-[#FFFDFC] p-[5px] rounded-[2px] text-primary leading-none text-[14px] font-normal capitalize">for
                                            Sale</span>
                                    ...
                                    <div class="py-[20px] px-[20px] text-left">
                                        <h3><a href="properties-details.html"
                                                class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary hover:text-secondary transition-all font-medium">Elite
                                                Garden Resedence.</a></h3>
                                        <h4><a href="properties-details.html"
                                                class="font-light text-[14px] leading-[1.75] underline">253 Montril
                                                Street, South Town, Miami</a></h4>
                            ...
                            <div class="swiper-slide">
                                <div
                                    ...
                                    <div class="relative">
                                        <a href="properties-details.html" class="block">
                                            <img src="assets/images/properties/properties3.png" class="w-full h-full"
                                                loading="lazy" width="370" height="266"
                                    ...
                                    <div class="py-[20px] px-[20px] text-left">
                                        <h3><a href="properties-details.html"
                                                class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary hover:text-secondary transition-all font-medium">De
                                                Parasiya Appartment.</a></h3>
                                        <h4><a href="properties-details.html"
                                                class="font-light text-[14px] leading-[1.75] underline">18B Central
                            ...
                            <div class="swiper-slide">
                                <div
                                    ...
                                    <div class="relative">
                                        <a href="properties-details.html" class="block">
                                            <img src="assets/images/properties/properties6.png" class="w-full h-full"
                                    ...
                                    <div class="py-[20px] px-[20px] text-left">
                                        <h3><a href="properties-details.html"
                                                class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary hover:text-secondary transition-all font-medium">Duplex
                                                de Villa.</a></h3>
                                        <h4><a href="properties-details.html"
                                                class="font-light text-[14px] leading-[1.75] underline">194 Mercer Street,
                                                627 Broadway, New York</a></h4>
                                        <span class="font-light text-sm">Added: 25 November, 2021</span>
                                        <ul
                                            class="flex flex-wrap items-center justify-between text-[12px] mt-[10px] mb-[15px] pb-[10px] border-b border-[#E0E0E0]">
                                            <li
                            ...
                            <div class="swiper-slide">
                                <div
                                    ...
                                    <div class="py-[20px] px-[20px] text-left">
                                        <h3><a href="properties-details.html"
                                                class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary hover:text-secondary transition-all font-medium">Orchid
                                                Casel de Paradise.</a></h3>
                                        <h4><a href="properties-details.html"
                                                class="font-light text-[14px] leading-[1.75] underline">2846 West Side
                                                Avenue, New Jersey</a></h4>
                                        <span class="font-light text-sm">Added: 25 November, 2021</span>
                                        <ul
                                            class="flex flex-wrap items-center justify-between text-[12px] mt-[10px] mb-[15px] pb-[10px] border-b border-[#E0E0E0]">
                                            <li
                            ...
                            <div class="swiper-slide">
                                <div
                                    ...
                                    <div class="py-[20px] px-[20px] text-left">
                                        <h3><a href="properties-details.html"
                                                class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary hover:text-secondary transition-all font-medium">Ruposibangla
                                                de parlosia.</a></h3>
                                        <h4><a href="properties-details.html"
                                                class="font-light text-[14px] leading-[1.75] underline">2381 Richards
                                                Avenue, Stockton, California</a></h4>
                                        <span class="font-light text-sm">Added: 25 November, 2021</span>
                                        <ul
                                            class="flex flex-wrap items-center justify-between text-[12px] mt-[10px] mb-[15px] pb-[10px] border-b border-[#E0E0E0]">
                                            <li
                            ...
                            <div class="swiper-slide">
                                <div
                                    ...
                                    <div class="py-[20px] px-[20px] text-left">
                                        <h3><a href="properties-details.html"
                                                class="font-lora leading-tight text-[22px] xl:text-[26px] text-primary hover:text-secondary transition-all font-medium">Sinomen
                                                Studio Palace.</a></h3>
                                        <h4><a href="properties-details.html"
                                                class="font-light text-[14px] leading-[1.75] underline">4658 Oakwood
                                                Avenue, New York</a></h4>
                                        <span class="font-light text-sm">Added: 25 November, 2021</span>
                                        <ul
                                            class="flex flex-wrap items-center justify-between text-[12px] mt-[10px] mb-[15px] pb-[10px] border-b border-[#E0E0E0]">
                                            <li
                        ...
                        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                            ...
                            <div class="swiper-slide">
                                <div
                                    ...
                                    <div class="relative">
                                        <a href="properties-details.html" class="block">
                                            <img src="assets/images/properties/properties7.png" class="w-full h-full"
                                                loading="lazy" width="370" height="266"
                                                alt="Orchid Casel de Paradise.">
                                        </a>
                                        <div class="flex flex-wrap flex-col absolute top-5 right-5">
                        ...
                        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                            ...
                            <div class="swiper-slide">
                                <div
                                    ...
                                    <div class="relative">
                                        <a href="properties-details.html" class="block">
                                            <img src="assets/images/properties/properties2.png" class="w-full h-full"
                                                loading="lazy" width="370" height="266"
                                                alt="Sinomen Studio Palace.">
                                        </a>
                                        <div class="flex flex-wrap flex-col absolute top-5 right-5">
