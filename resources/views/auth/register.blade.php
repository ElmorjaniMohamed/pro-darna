            ...
            <div
                ...
                <div
                    ...
                    <div class="w-full max-w-[440px] lg:mt-16">
                        ...
                        <form id="form" action="{{ route('register') }}" method="POST" class="space-y-6 dark:text-white">
                            @csrf
                            @method('POST')
                            <div class="form-control">
                                ...
                                <div class="relative text-white-dark">
                                    ...
                                    <i class="absolute end-4 top-1/2 -translate-y-1/2 text-green-500 fas fa-check-circle"
                                        style="display: none;"></i>
                                    <i class="absolute end-4 top-1/2 -translate-y-1/2 text-red-500 fa-solid fa-circle-exclamation"
                                        style="display: none;"></i>
                                    <small class="absolute bottom-0 top-9 left-0 text-red-500 hidden">Error
                                        message</small>
