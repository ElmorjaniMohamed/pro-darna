...
<x-layout.default>
            ...
            <div class="bg-white dark:bg-gray-900 relative shadow-md sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div
                        ...
                        <a href="{{ route('propertyAmenities.create') }}"
                ...
                <div class="overflow-x-auto">
                    <table id="amenityTable" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            @foreach ($propertyAmenities as $amenity)
                                <tr class="border-b dark:border-gray-700" id="{{ 'amenity_' . $amenity->id }}">
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $amenity->name }}
                                    </td>
                                    </td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">{{ $amenity->created_at }}
                                    </td>
                                    <td class="px-4 py-3">{{ $amenity->updated_at }}</td>
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <ul class="flex items-center justify-center gap-2">
                                            <li>
                                                <a href="{{ route('propertyAmenities.edit', $amenity->id) }}"
                                                    x-tooltip="Edit">
                                            ...
                                            <li>
                                                <button type="button" data-id="{{ $amenity->id }}" class="deleteButton">
                                                    <svg width="24" height="24" viewBox="0 0 24 24"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg"
    ...
    <script>
        $(document).ready(function() {
            $("#amenityTable").on("click", ".deleteButton", function() {
                ...
                if (amenityId) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: `/admin/propertyAmenities/${amenityId}`,
                                type: "DELETE",
                                headers: {
