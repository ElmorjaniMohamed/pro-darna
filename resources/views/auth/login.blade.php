<x-layout.auth>
    ...
    <div x-data="auth">
        ...
        <div class="relative flex min-h-screen bg-[#B39359] items-center justify-center px-6 py-10 dark:bg-[#060818] sm:px-16">
                    ...
                    <div class="w-full max-w-[440px] lg:mt-16">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div>
                                    <a href="{{ route('forget.password.get') }}"
                                        class="text-sm text-secondary underline transition hover:text-primary dark:hover:text-white">Forgot
                                        password?</a>
                                </div>
                        ...
                        <div class="text-center dark:text-white">
                            ...
                            <a href="{{ route('register') }}"
                                class="uppercase  text-secondary underline transition hover:text-primary dark:hover:text-white">SIGN
                                UP</a>
                        </div>
                    </div>
