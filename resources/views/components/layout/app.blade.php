                    ...
                    <div class="col-span-12">
                        <div class="flex flex-wrap items-center justify-between">
                            <a href="index.html" class="block">
                                <img class="w-2 h-2 white-logo" src="assets/images/logo/logo-white.svg" loading="lazy" width="56" height="46" alt="brand logo">
                                <img class="w-2 h-2 hidden dark-logo" src="assets/images/logo/logo.svg" loading="lazy" width="56" height="46" alt="brand logo">
                            </a>
                ...
                <div class="grid grid-cols-12 gap-x-[30px] mb-[-30px]">
                    <div class="col-span-12 sm:col-span-6 lg:col-span-4 mb-[30px]">
                        <a href="index.html" class="block mb-[25px]">
                            <img src="assets/images/logo/logo.svg" width="56" height="46" loading=lazy alt="footer logo">
                        </a>
